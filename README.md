This repository contains the datasets and [RevBayes](https://github.com/revbayes/revbayes) script needed to reproduce the results in [Pett et al. 2018](https://www.biorxiv.org/content/early/2018/06/08/341115).
