This repository contains the datasets and [RevBayes](https://github.com/revbayes/revbayes) script needed to reproduce the results in [Pett et al. 2019](http://dx.doi.org/10.1093/molbev/msz013).
